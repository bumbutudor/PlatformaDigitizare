...
from .views import upload, preprocess, ocr, transliterate, publish, home, exception_dictionary, serve_media, check_searchable_pdf
...
urlpatterns = [
    ...
    path('check-pdf/', check_searchable_pdf, name='check_searchable_pdf'),
