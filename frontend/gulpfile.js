...
gulp.task(
  ...
  gulp.series("lint", function (done) {
    ...
    return gulp.src(["./tests/**/*.spec.js"], { read: false }).pipe(
      $.mocha({
        reporter: "spec",
...
gulp.task(
  "build",
  gulp.series("lint", "clean", function (done) {
    done();
...
gulp.task(
  ...
  gulp.series("build", function (done) {
    ...
    webpack(webpackConfig, function (err, stats) {
      ...
      gulp
        .src("./src/digitizare/dist/bundle.js")
        .pipe(gulp.dest("./docs/dist"));

      gulp.src("./dist/main.js").pipe(gulp.dest("./docs"));

      gulp.src("./src/digitizare/index.html").pipe(gulp.dest("./docs/"));
    });
