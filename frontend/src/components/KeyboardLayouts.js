  ...
  cyrillicTransitional: {
    layout: {
      ...
      shift: [
        ...
        "{shift} З Ѯ Ч В Б N M Ѣ Ѧ Ѩ Ю ОУ Ь Ѵ Ѱ Ѕ {shift}",
        "{space} . : ; ! ? „ “ ” ' \" ( ) [ ] { }",
      ],
    },
  },
  ...
  cyrillicRomanian: {
    layout: {
      default: [
        ...
        "{lock} а с д ф г х ж к л ц ш щ џ {enter}",
        "{shift} ζ з ѯ ч в б н м ѣ ѧ ѩ ю ѹ ь ѵ ѱ ѕ / {shift}",
        "{space} . : ; ! ? „ “ ” ' \" ( ) [ ] { }",
      ],
      shift: [
        "~ ! „ “ ” % ^ & * ( ) _ + {bksp}",
        "{tab} Ѳ Ѡ Е Р Т Ї Ꙋ И О П Ъ Ꙟ Ѫ",
        '{lock} А С Д Ф Г Х Ж К Л Ц Ш Щ Џ {enter}',
        "{shift} Ζ З Ѯ Ч В Б Н М Ѣ Ѧ Ѩ Ю ОУ Ь Ѵ Ѱ Ѕ {shift}",
        "{space} . : ; ! ? „ “ ” ' \" ( ) [ ] { }",
      ],
    },
  },
